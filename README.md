...
> **Note:** This is an unofficial fork of [AdiBags](https://github.com/AdiAddons/AdiBags) maintained because I just like the look of AdiBags and cba moving to a new bag addon. Development here is focused exclusively on **retail WoW** — classic, TBC, Wrath, Cata, and other versions are not actively maintained in this fork. If you're looking for the latest addon from the original maintainers of AdiBags, you want [BetterBags](https://www.curseforge.com/wow/addons/better-bags).
